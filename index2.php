...
$connect = new PDO("mysql:host=localhost;dbname=cookie", "root", "");
...
if(isset($_GET["action"]))
{
	if($_GET["action"] == "delete")
	{
		...
		foreach($cart_data as $keys => $values)
		{
			if($cart_data[$keys]['item_id'] == $_GET["id"])
			{
				...
				$item_data = json_encode($cart_data);
				setcookie("shopping_cart", $item_data, time() + (86400 * 30));
				header("location:index2.php?remove=1");
			}
		}
	}
	if($_GET["action"] == "clear")
	{
		...
		header("location:index2.php?clearall=1");
	}
}
	...
	<body>
		...
		<div class="section">
			...
			<p class="product-category"><?php echo $row["category"]?></p>
				<form method="post">
					<div class="product-img">
						<img  id="sizeimg" class="center" src="images/<?php echo $row["image"]; ?>" class="img-responsive" /><br />
		...
		<div style="clear:both"></div>
			...
			<?php echo $message; ?>
			<div align="right">
				<a href="index2.php?action=clear"><b>Clear Cart</b></a>
			</div>
