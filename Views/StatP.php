...
<tr>
<td>Nombre de Produits total</td>
<?PHP
...
?>
<td>Nombre de Produits Alimentation</td>
<?PHP
foreach($nbAlimentationProduit as $row){
    ?>
    <tbody id="myTable">
    <tr >
    <td><?PHP echo $row[0]; ?></td>
...
?>
<td>Nombre de Produits Charcuterie</td>
<?PHP
foreach($nbCharcuterieProduit as $row){
    ?>
    <tbody id="myTable">
    <tr >
    <td><?PHP echo $row[0]; ?></td>
...
?>
<td>Nombre de Produits Promo</td>
<?PHP
foreach($nbPromoProduit as $row){
    ?>
    <tbody id="myTable">
    <tr >
    <td><?PHP echo $row[0]; ?></td>
...
?>
<td>Nombre de Produits Cuisine</td>
<?PHP
foreach($nbCuisineProduit as $row){
    ?>
    <tbody id="myTable">
    <tr >
    <td><?PHP echo $row[0]; ?></td>
...
?>
<td>Nombre de Produits Librairie</td>
<?PHP
foreach($nbLibrairieProduit as $row){
    ?>
    <tbody id="myTable">
    <tr >
    <td><?PHP echo $row[0]; ?></td>
...
?>
<td>Nombre de Produits Ménage</td>
<?PHP
foreach($nbMenageProduit as $row){
    ?>
    <tbody id="myTable">
    <tr >
    <td><?PHP echo $row[0]; ?></td>
...
?>
<td>Nombre de Produits Beauté</td>
<?PHP
foreach($nbBeauteProduit as $row){
    ?>
    <tbody id="myTable">
    <tr >
    <td><?PHP echo $row[0]; ?></td>
...
?>
<td>Prix le plus élevé</td>
<?PHP
foreach($prixhProduit as $row){
    ?>
    <tbody id="myTable">
    <tr >
    <td><?PHP echo $row[0]; ?></td>
