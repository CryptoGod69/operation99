...
$listCateg=$CategorieC->afficherCategorie();
?>
<!doctype html>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="product-edit.php">Ajouter un produit</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Mise a jour Produit</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i>Mise a jour produit</a></li>
...
?>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                        ...
                                        <form method="POST" enctype="multipart/form-data" id="ajoutprod" onsubmit="return verifa();">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="ID" name="id" id="idprod" value="<?PHP echo $id ?>" disabled>
                                                            </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Nom De Produit" name="Nom" id="nomprod"  value="<?PHP echo $Nom ?>" required>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-sticky-note-o" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Statut" name="statut" id="statutprod" value="<?PHP echo $statut ?>"required>
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Description Produit" name="Descr" id="descprod" value="<?PHP echo $Descr ?>" required>
                                                    </div>
                                                  
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                        <SELECT name="Categorie" size="1" id="Categorie"   class="form-control">
                                                        <option value="0"  hidden selected >Selectionner une Categorie</option>
<?php   
                                                     foreach($listCateg as $row1){
?>

                                                          <OPTION value="<?PHP echo $row1['Categ']; ?>"><?PHP echo $row1['Categ']; ?></option>
                                                          <?PHP
}
?>
</SELECT>
                                                ...
                                                <div class="review-content-section">
                                                    ...
                                                    <input type="file" class="custom-file-input" name="image" accept="image/png" value=" <?PHP  echo "<img src='images/".$row['image']."'>" ?>" id="image" > 
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" name="update" value="update"  >
...
if (isset($_POST['update'])){
	...
	$Produit=new produit($_POST['id'],$_FILES['image']['name'],$_POST['Descr'],$_POST['Categorie'],$_POST['statut'],$_POST['Nom']);
    $ProduitC->modifierProduit($Produit,$_POST['id']);
    unlink("images/" . basename($_FILES['image']['name']));
...
var erreur=0;
    ...
    if( document.getElementById("image").files.length == 0 ){erreur=4;
...
if (erreur==1)
{
    swal("nomprod doit être non vide" , "" , "error");
    return false;
}
if (erreur==2)
{
    swal("statutprod doit être non vide" , "" , "error");
    return false;
}
if (erreur==3)
{
    swal("descprod doit être non vide" , "" , "error");
    return false;
}
if (erreur==4)
{
    swal("veuillez sélectionner une image" , "" , "error");
    return false;
}
if (erreur==5)
{
    swal("Statut Doit etre Soit 'Disponible' ou 'Non Disponible'" , " " ,"error");
    return false;
}
if (erreur==6)
{
    swal("Le nom doit contenir aucune espace " , "" , "error");
    return false;
}
if (erreur==7)
{
    swal ("Veuillez choisir une Categorie" , "" , "error");
    return false;
}
if (erreur==0)
{
    swal("Produit Enregister !", "Verifier La Base ", "success");
}
