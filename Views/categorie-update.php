...
?>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                        ...
                                        <form method="POST" enctype="multipart/form-data" id="ajoutcateg" onsubmit="return verifcateg();">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <input type="text" class="form-control"name="id_cat" id="id_cat" value="<?PHP echo $id_cat ?>" disabled >
                                                            </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control"  name="Categ" id="Categ"  value="<?PHP echo $Categ ?>" required>
                                                    </div>
                                    ...
                                    <input type="hidden" name="id_cat" value="<?PHP echo $_POST['id_cat'];?>">
...
if (isset($_POST['update'])){
	$Categorie=new categorie($_POST['id_cat'],$_POST['Categ']);
    $CategorieC->modifierCategorie($Categorie,$_POST['id_cat']);
?>
<script>
  window.location.href = "categorie-list.php";
</script>
<?php
}
?>
