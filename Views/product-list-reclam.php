<?PHP
include_once "../Core/ProduitRetourneP.php";
...
$listeProduitretourne=$ProduitRetourne1P->afficherProduits();
}
elseif ($choix=="choix1")
{
    $listeProduitretourne=$db->query('SELECT * FROM produits_retournes ORDER BY ID_client ASC'); 
}
elseif ($choix=="choix2")
{
    $listeProduitretourne=$db->query('SELECT * FROM produits_retournes ORDER BY ID_client DESC'); 
}
elseif ($choix=="choix3")
{
    $listeProduitretourne=$db->query('SELECT * FROM produits_retournes ORDER BY Nom ASC'); 
}
elseif ($choix=="choix4")
{
    $listeProduitretourne=$db->query('SELECT * FROM produits_retournes ORDER BY Nom DESC'); 
}
?>
<!doctype html>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcome-heading">
                                            <form method="get" action="recherche-prod-ret.php">
                                                <tr>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <form action="product-list-reclam.php" method="GET"> 
                            <select name="tri"> 
                            <option value="choix1"> Identifiant Ascendant</option>
                            <option value="choix2"> Identifiant Descendant</option>
                            <option value="choix3">Nom de A à Z</option>
                            <option value="choix4">Nom de Z à A</option>
                            </select>
                            <button type="submit"> Trier </button>
                            </form>
                            </div>
                            <div class="add-product">
                                <a href="product-ret-edit.html">Add Product</a>
                            </div>
                            <table class="table table-bordered table-striped">
                                ...
                                <?PHP
                                 foreach($listeProduitretourne as $row){
                            	?>
                                <tr>
                                    ...
                                    <td><form method="POST" action="supprimerProduitretour.php">  
                                        <input class="bin btn-primary waves-effect waves-light m-r-10" type="submit" name="trash" value="trash">
                                        <input type="hidden" value="<?PHP echo $row['Ref_Reclam']; ?>" name="Ref_Reclam">
                                 </form>
                                    </td>
                                </tr>
                                <?php
