...
$nbProduit=$produit1C->nombreProduit();
$nbFournisseur=$fournisseur1C->nombreFournisseur();

$nbAlimentationProduit=$produit1C->nombreCatProduit("Alimentation");
$nbBoissonProduit=$produit1C->nombreCatProduit("Boisson");
$nbCharcuterieProduit=$produit1C->nombreCatProduit("Charcuterie");
$nbPromoProduit=$produit1C->nombreCatProduit("Promo");
$nbCuisineProduit=$produit1C->nombreCatProduit("Cuisine");
$nbLibrairieProduit=$produit1C->nombreCatProduit("Librairie");
$nbMenageProduit=$produit1C->nombreCatProduit("Menage");
$nbBeauteProduit=$produit1C->nombreCatProduit("Beaute");

$prixbProduit=$produit1C->prixbProduit();
$prixhProduit=$produit1C->prixhProduit();
...
<head>
    ...
    <title>Analytics | jeweler - Material Admin Template</title>
                        ...
                        <div class="income-dashone-total reso-mg-b-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    ...
                                    <?php
                                                      foreach($nbProduit as $row1){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row1[0]; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                                ...
                                <div class="income-range">
                                    ...
                                    <span class="income-percentange bg-green"><span class="counter">100</span>% <i class="fa fa-bolt"></i>
                                    </span>
                                </div>
                                <div class="clear"></div>
                            </div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($nbFournisseur as $row2){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row2[0]; ?></span></h3>
                                        <?PHP
                                        }
                                        ?>
                                    </div>
                                ...
                                <div class="income-range order-cl">
                                    <p>Nombre Total de Fournisseurs</p>
                                    <span class="income-percentange bg-red"><span class="counter">100</span>% <i class="fa fa-level-up"></i>
                                    </span>
                                </div>
                                <div class="clear"></div>
                            </div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($nbAlimentationProduit as $row3){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row3[0]; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                                ...
                                <div class="income-range visitor-cl">
                                    <p>Nombre de Stocks Alimentaire</p>
                        ...
                        <div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($nbBoissonProduit as $row4){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row4[0]; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                                ...
                                <div class="income-range visitor-cl">
                                    <p>Nombre de Stocks de Boisson</p>
                                    <span class="income-percentange bg-blue"><span class="counter">100</span>% <i class="fa fa-level-up"></i>
                                    </span>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($nbCharcuterieProduit as $row5){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row5[0]; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                                ...
                                <div class="income-range visitor-cl">
                                    <p>Nombre de Stocks de Charcuterie</p>
                                    <span class="income-percentange bg-blue"><span class="counter">100</span>% <i class="fa fa-level-up"></i>
                                    </span>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($nbPromoProduit as $row6){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row6[0]; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($nbCuisineProduit as $row7){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row7[0]; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                                ...
                                <div class="income-range visitor-cl">
                                    <p>Nombre de Stocks de Cuisine</p>
                                    <span class="income-percentange bg-blue"><span class="counter">100</span>% <i class="fa fa-level-up"></i>
                                    </span>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($nbLibrairieProduit as $row8){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row8[0]; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                                ...
                                <div class="income-range visitor-cl">
                                    <p>Nombre de Stocks de Librairie</p>
                                    <span class="income-percentange bg-blue"><span class="counter">100</span>% <i class="fa fa-level-up"></i>
                                    </span>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($nbMenageProduit as $row9){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row9[0]; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                                ...
                                <div class="income-range visitor-cl">
                                    <p>Nombre de Stocks de Menage</p>
                                    <span class="income-percentange bg-blue"><span class="counter">100</span>% <i class="fa fa-level-up"></i>
                                    </span>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($nbBeauteProduit as $row10){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row10[0]; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                                ...
                                <div class="income-range visitor-cl">
                                    <p>Nombre de Stocks de Beaute</p>
                                    <span class="income-percentange bg-blue"><span class="counter">100</span>% <i class="fa fa-level-up"></i>
                                    </span>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($prixbProduit as $row11){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row11[0]; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($prixhProduit as $row12){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row12[0]; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
