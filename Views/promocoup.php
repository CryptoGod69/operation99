                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Coupon de Promo</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Générer un coupon de promotion</a></li>
                                    
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                <form method="post" action="ajouter_coupon.php" enctype="multipart/form-data" id="ajoutprod" onsubmit="return verifa();">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="review-content-section">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <?php
                                                      foreach($vmaxid as $row){
                                                          ?>
                                                          <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                                    <input type="text" class="form-control" value="<?PHP echo $row['MAX(id_coupon)+1']; ?>" id="id_coupon" name="id_coupon" disabled>
                                                                    <?PHP
}
?>
                                                                </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <SELECT name="Type_reduction" size="1" id="Type_reduction"   class="form-control">
                                                      
                                                        <option value="0" disabled  selected hidden  >Type De Réduction</option>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input class="btn btn-primary waves-effect waves-light m-r-10" name="générer " onclick="randomValue();" value="Générer "  >
                                                    </div>   
                                                    <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
