                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" value="Afficher" onclick="window.location='AfficherFournisseur.php';">
                            ...
                            <tr>
                                    ...
                                    <th>Ajouter</th>
                                        ...
                                        <form  method="POST" action="ajoutFournisseur.php" enctype="multipart/form-data">
                                     <tbody id="myTable">
                                <tr>
                                    ...
                                    <td><input type="text" name="mat" class="form-control"></td>
                                    
                                    <td><input type="number" name="rib" class="form-control"></td>

                                    <td>
                                    
                                    <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" name="save" value="Ajouter" >
                                    </td>
                                </tr>
                                  </tbody>
                                  </form>
