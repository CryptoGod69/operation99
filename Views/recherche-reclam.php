...
$Reclam= new ReclamR();
$listeReclam=$Reclam->rechercherReclam($search_value);
                        ...
                        <nav class="sidebar-nav left-sidebar-menu-pro">
                            ...
                            <li class="active">
                                ...
                                <li>
                                    ...
                                    <ul class="submenu-angle" aria-expanded="false">
                                        <li><a title="AfficherFournisseur" href="AfficherFournisseur.php"><i class="fa fa-book" aria-hidden="true"></i> <span class="mini-sub-pro">Afficher Fournisseur</span></a></li>
                                        <li><a title="AjouterFournisseur" href="AjouterFournisseur.html"><i class="fa fa-plus" aria-hidden="true"></i> <span class="mini-sub-pro">Ajouter Fournisseur</span></a></li>
                                        <li><a title="ModifierFournisseurt" href="ModifierFournisseur.php"><i class="fa fa-pencil" aria-hidden="true"></i> <span class="mini-sub-pro">Modifier Fournisseur</span></a></li>
                                        <li><a title="SupprimerFournisseur" href="SupprimerFournisseur.html"><i class="fa fa-minus" aria-hidden="true"></i> <span class="mini-sub-pro">Supprimer Fournisseur</span></a></li>
                                        
                                        <li><a title="Analytics" href="StatF.php"><i class="fa fa-line-chart sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Statistiques Fournisseur</span></a></li>
                                        <li><a title="Analytics" href="StatP.php"><i class="fa fa-line-chart sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Statistiques Produit</span></a></li>
    
                                        <li><a title="AfficherProduit" href="AfficherProduit_stock.php"><i class="fa fa-book" aria-hidden="true"></i> <span class="mini-sub-pro">Afficher Produit</span></a></li>
                                        <li><a title="AjouterProduit" href="AjouterProduit.html"><i class="fa fa-plus" aria-hidden="true"></i> <span class="mini-sub-pro">Ajouter Produit</span></a></li>
                                        <li><a title="ModifierProduit" href="ModifierProduit.php"><i class="fa fa-pencil" aria-hidden="true"></i> <span class="mini-sub-pro">Modifier Produit</span></a></li>
                                        <li><a title="SupprimerProduit" href="SupprimerProduit.html"><i class="fa fa-minus" aria-hidden="true"></i> <span class="mini-sub-pro">Supprimer Produit</span></a></li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li>
                                        <a class="has-arrow" href="mailbox.html" aria-expanded="false"> <span class="mini-click-non">Service Après Vente</span></a>
                                        <ul class="submenu-angle" aria-expanded="false">
                                                <li><a title="Product List" href="product-list-reclam.php"><i class="fa fa-female sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste des produits retournés</span></a></li>
                                                ...
                                                <li><a title="Analytics" href="statprod-ret.php"><i class="fa fa-line-chart sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Statistiques Produits</span></a></li>
                                                <li><a title="Analytics" href="statReclam.php"><i class="fa fa-line-chart sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Statistiques Réclamations</span></a></li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="reclam-list.php">Product List</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Produits retournes</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
