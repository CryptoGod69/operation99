                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="product-list.php">Categorie </a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Categorie</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="categorie-edit.php">Ajouter Categorie</a>
                            </div>
                            <div class="container">
                                <input class="form-control" id="myInput" type="text" placeholder="Chercher une Categorie..">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td><form method="POST" action="categorie-update.php">
                                    ...
                                    <td><form method="POST" action="convertAll.php">
