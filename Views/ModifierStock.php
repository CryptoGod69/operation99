...
$pmod=$ProduitC->recupererProduit($_GET["id"],$_GET["Fournisseur"]);
}
?>
                            ...
                            <tr>
                                ...
                                foreach($pmod as $row){
                                    ?>
                                        ...
                                        <form  method="POST" action="modStock.php" enctype="multipart/form-data">
                                     <tbody id="myTable">
                                <tr>
                                    ...
                                    <td><?PHP echo $row['Fournisseur']; ?> <input type="hidden" name="Fournisseur" value="<?PHP echo $row['Fournisseur']; ?>" name="Nom"></td>
                                    <td>
