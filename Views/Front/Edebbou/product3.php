										...
										<div class="cart-list">
											<div class="product-widget">
												...
												<div class="product-body">
													<h3 class="product-name"><a href="#">product here</a></h3>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">TEEEEEEEEEEEEEEEEEST</h2>
							<div>
							...
							<div>
								<h3 class="product-price">0.210 TND <del class="product-old-price">0.210 TND</del></h3>
