...
<li>
<a href="register.html"><i class="fa fa-user-o"></i>
<?php 
session_start ();  if (isset($_SESSION['l']) && isset($_SESSION['p'])) 
{ 
...
{
	echo '<a href="../../../Views/index.html">'.$_SESSION['f']     ;
}
}
?>             
<a class="btn btn-lg btn-danger" href="registerpremium.php">
 <span>Passer Premium<br></span></a> 
			...
			<div class="form-group"><a href="index.html"></a>
				<input type="submit" class="btn btn-lg btn-warning" value="Avoir une carte de fédilité" ><a href="index4.php"></a></button>
			</div> <!-- form-group// -->                                                                      
		</form>
				</a>
							</div>
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href="file:///G:/WorkSpace/edebbou.me/operation99-dali0/Desktop/Page/Nouveau%20dossier/me/product.html">Le Brassé</a></h3>
