...
function check_val()
{
 ...
 var check_text=document.getElementById("comment_content").value;
 var error=0;
 ...
 if(error>0)
 {
  document.getElementById("bad_notice").innerHTML="WARNING: Some Bad Words In Your Text , Posting this may cause a BAN";
 }
 else
 {
			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						...
						<li><a href="https://www.google.com/maps/dir//20+Rue+des+Jasmins,+Ariana/@36.8511555,10.1824785,19.25z/data=!4m17!1m7!3m6!1s0x12fd34b04988d4cd:0x4c3c5f810d3512e9!2s20+Rue+des+Jasmins,+Ariana!3b1!8m2!3d36.8513191!4d10.183!4m8!1m0!1m5!1m1!1s0x12fd34b04988d4cd:0x4c3c5f810d3512e9!2m2!1d10.183!2d36.8513191!3e0" target="_blank"><i class="fa fa-map-marker"></i> 20, Rue Les Jasmins, Nv Ariana</a></li>
					</ul>
					<ul class="header-links pull-right">
						...
						<?php 
						 session_start() 
						 ?>
						<li><a href="login.html"><i class="fa fa-user-o"></i><?php echo $_SESSION['l']; ?></a></li>
					...
					<div class="row">
						...
						<div class="col-md-3 clearfix">
							<div class="header-ctn">
								...
								<!--hedhi l panier fi cookie ya dali hhh Cart -->
								<div class="dropdown">
...
?>
											<div class="product-widget">
												...
												<td><a href="product4.php?action=deletep&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">X</span></a></td>
											</div>
<?php
...
?> 
                       TND </h5>
										...
										<div class="cart-btns">
											<a href="product4.php?action=clearp" >Clear Cart</a>
	...
	<!--hedhi l panier fi cookie ya dali hhh Cart -->
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Dra shneyaaaaa</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
		...
		<div class="section">
			...
			<div class="container">
				...
				<!--yaffichi les articles mel BD bel ROW -->
			<?php
...
?>
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price"><?php echo $row["price"]; ?> TND<del class="product-old-price"><?php echo $row["price"]; ?> TND</del></h3>
							...
							<div class="add-to-cart">
								<div class="qty-label">
									...
									<div class="input-number">
										<input name="quantity" value="1" min=1 max=99  id="qtt" type="number">
...
<button  name="add_to_cartP" type="submit" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>Ajouter Au Panier</button>			
</div>
							...
							<ul class="product-links">
								<li>Catégorie:</li>
								<li><a href="#">Alimentaires</a></li>
								<li><a href="#"><?php echo $row["category"]?></a></li>
							</ul>

							<ul class="product-links">
								<li>Partagez l'article:</li>
							...
							<table class="table colored-header datatable project-list">
								...
								<tbody>
									<tr>
										...
										<td>0.200 TND</td>
										<td><img src="img/profil/avatar1.png" alt="Avatar" class="avatar img-circle"> <a href="#">Michael</a></td>
										<td><span class="label label-success">100+</span></td>
									</tr>


									<tr>
										<td><a href="product.html">Vitalait Le Brassé</a></td>
										<td>1-16-2019</td>
										<td>4-6 Days</td>
										<td>
											<div class="progress">
										...
										<td>0.185 TND</td>
										<td><img src="img/profil/avatar2.png" alt="Avatar" class="avatar img-circle"> <a href="#">Antonius</a></td>
									...
									<tr>
										...
										<td>0.200 TND</td>
										<td><img src="img/profil/avatar3.png" alt="Avatar" class="avatar"> <a href="#">Antonius</a></td>
									...
									<tr>
										...
										<td>0.200 TND</td>
										<td><img src="img/profil/avatar4.png" alt="Avatar" class="avatar"> <a href="#">Michael</a></td>
									...
									<tr>
										...
										<td>0.210 TND</td>
										<td><img src="img/profil/avatar5.png" alt="Avatar" class="avatar"> <a href="#">Jason</a></td>
									...
									<tr>
										...
										<td>0.190 TND</td>
										<td><img src="img/profil/avatar6.png" alt="Avatar" class="avatar"> <a href="#">Michael</a></td>
									...
									<tr>
										...
										<td>0.160 TND</td>
										<td><img src="img/profil/avatar7.png" alt="Avatar" class="avatar"> <a href="#">Jason</a></td>
					...
					<!--OFFERS WITH OTHER PRICES-->
								...
								<div id="tab3" class="tab-pane fade in">
									<div class="row">
										...
										<!-- /Rating -->
										<br />	
<!-- w hedhouma les commentaires + AJAX f lekher -->
		
</div>
  <div class="container">
   <form method="POST" id="comment_form">
    <div class="form-group">
     <textarea onKeyUp="check_val()" name="comment_content" id="comment_content" class="form-control" placeholder="Enter Comment" rows="5"></textarea>
    </div>
    <div class="form-group">
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								<p class="product-category">Category</p>
								<h3 class="product-name"><a href="#">product name goes here</a></h3>
								<h4 class="product-price">$9.00 <del class="product-old-price">$990.00</del></h4>
								<div class="product-rating">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
