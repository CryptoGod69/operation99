...
<div>
	...
	<div align="center" class="container">
		...
		<div class="card-body " style="max-width: 300px;">
			...
			<form id="insc" method="POST" action="ajoutpremium.php" onsubmit="return verifa();" >
            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    <form role="form" id="payment-form" method="POST" action="ajoutpremium.php" onsubmit="return verifa();">
                        <div class="row">
                            <div class="col-xs-12">
				...
				<input name="IDP" class="form-control" value=<?php echo $_SESSION['i']?> type="hidden" id="IDP" >
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <input  type="submit" class="btn btn-primary btn-block" value="Passer Premium" onclick="verifa();" ><a href="ajoutCDF.php"></a></button>
                            </div>
                        </div>
    ...
    function verifa()
{
	var CodeNum=document.forms["payment-form"]["CodeNum"].value;
	var CVCode=document.forms["payment-form"]["CVCode"].value;
	insc
	var CodeNum1=document.forms["insc"]["CodeNum"].value;
	var CVCode1=document.forms["insc"]["CVCode"].value;
var erreur=0;
	if(CodeNum.length==0)
	{
        erreur=1;
