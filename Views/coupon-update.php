...
$couponC=new CouponC();
$listCateg=$couponC->afficherCouponC();
?>
<!doctype html>
...
?>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <input type="text" class="form-control" name="id_coupon" id="id_coupon" value="<?PHP echo $id_coupon ?>" disabled>
                                                            </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="code_coupon" id="code_coupon"  value="<?PHP echo $code_coupon ?>" required>
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                  
                                                  <span class="input-group-addon"><i class="fa fa-sticky-note-o" aria-hidden="true"></i></span>
                                                  <SELECT name="Type_reduction" size="1" id="Type_reduction"  onChange="idprod.value=this.value;"  class="form-control">
                                                     
                                                          <OPTION>Pourcentage</option>
                                                          <option>Bon D'achat</option>
                                             ...
                                             <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                 <div class="review-content-section">
                                                  ...
                                                  <span class="input-group-addon"><i class="fa fa-sticky-note-o" aria-hidden="true"></i></span>
                                                  <input type="text" class="form-control" name="Valeur" id="Valeur" value="<?PHP echo $Valeur ?>"required>
                                              </div>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="date" class="form-control" name="Date_Debutcoupon" id="Date_Debutcoupon" value="<?PHP echo $Date_Debutcoupon ?>" required>
                                                    </div>
                                                  
                                                  
                                                    <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="fa fa-ticket" aria-hidden="true"></i></span>
                                                    <input type="date" class="form-control" name="Date_Fincoupon" id="Date_Fincoupon" value="<?PHP echo $Date_Fincoupon ?>" required>
                                    ...
                                    <input type="hidden" name="id_coupon" value="<?PHP echo $_POST['id_coupon'];?>">
...
if (isset($_POST['update'])){
	$Coupon=new coupon($_POST['id_coupon'],$_POST['code_coupon'],$_POST['Type_reduction'],$_POST['Valeur'],$_POST['Date_Debutcoupon'],$_POST['Date_Fincoupon']);
    $couponC1->modifierCoupon($Coupon,$_POST['id_coupon']);
   ?>
   <script>
window.location.href = "promo-list.php";
</script>
<?php
}
?>
