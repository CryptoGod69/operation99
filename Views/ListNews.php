                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Chartsmob" href="#">Clients <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul id="Chartsmob" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="ListNews.html">List Email des News</a>
                                                </li>
...
$News1C=new NewsC();
$listeNews=$News1C->afficherNews();

//var_dump($listeNewss->fetchAll());
?>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd" align="center">
                                    <h1>List <span class="table-project-n">Des</span> Emails</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_News" >ID_News</th>
                                                <th data-field="Email_News" >Email_News</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?PHP
                                         foreach($listeNews as $row){
	                                    ?>
	<tr>
	
	<td><?PHP echo $row['ID_News']; ?></td>
	<td><?PHP echo $row['Email_News']; ?></td>

	<td><form method="POST" action="supprimerNews.php">
