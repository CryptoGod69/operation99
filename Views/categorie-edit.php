...
$vidcateg=$CategorieC->maxid_categorie();
?>
<!doctype html>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Ajouter une categorie</a></li>
                                    
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                        <form method="post" action="ajouter_categorie.php" enctype="multipart/form-data" id="ajoutcateg" onsubmit="return verifcateg();">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <?php
                                                            foreach ($vidcateg as $row1){
                                                                ?>
                                                                <input type="text" class="form-control" value="<?PHP echo $row1['MAX(id_cat)+1']; ?>" name="id_cat" id="id_cat" disabled>
                                                            <?php
}
                                                            ?>
                                                            </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Nom Categorie" name="Categ" id="Categ" required>
                                                    </div>
                                            </div>
                                        </div>
                                        <div class="row">
    ...
    function verifcateg()
{
    ...
    if(Categ.length==0)
	{
        swal("Categ doit être non vide" , "" , "error");
       return false;
    }
    if (Categ.indexOf(' ')>0)
    {
        swal("Le nom du categorie doit contenir aucune espace " , "" , "error");
	return false;	
    }
}
