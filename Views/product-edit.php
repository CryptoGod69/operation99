...
$listeEmployes=$CategorieC->afficherCategorie();
$ProduitC1= new produitC();
$vmax=$ProduitC1->maxid_produit();
?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Ajouter un produit</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                        <form method="post" action="ajouter_produit.php" enctype="multipart/form-data" id="ajoutprod" onsubmit="return verifa();">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <?php
                                                      foreach($vmax as $row1){
                                                          ?>
                                                                <input type="text" class="form-control" value="<?PHP echo $row1['MAX(id)+1']; ?>"  id="idprod"  disabled>
                                                                <?PHP
}
?>
                                                            </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Nom De Produit" name="Nom" id="nomprod" >
                                                      
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-sticky-note-o" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Statut" name="statut" id="statutprod" >
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Description Produit" name="Descr" id="descprod" >
                                                    </div>
...
?>
                                                    ...
                                                    <input  type="file" class="custom-file-input" name="image" accept="image/png" id="image"  style="display:none;">
                                                    <label class="custom-file-input" for="image">Cliquez pour choisir une image</label>
