...
<?PHP
    include "../Entities/produit_stock.php";
    include "../Core/produit_stockC.php";
if (isset($_POST['idp'])){
    $produitC=new ProduitC();
    $result=$produitC->recupererProduit($_POST['idp']);
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input id="IDp" name="idp" type="number" value="<?PHP if(isset($idp)){ echo $idp; }?>" class="form-control" placeholder="ID Produit">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input id="Nomprod" name="nomp" type="text" value="<?PHP if(isset($nomp)){ echo $nomp; }?>" class="form-control" placeholder="Nom produit">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input id="Prix" name="prixp" type="number" value="<?PHP if(isset($prixp)){ echo $prixp; }?>" class="form-control" placeholder="Prix">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-barcode" aria-hidden="true"></i></span>
                                                        <input id="Code" name="codep" type="number" value="<?PHP if(isset($codep)){ echo $codep; }?>" class="form-control" placeholder="Code Barre">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-archive" aria-hidden="true"></i></span>
                                                        <input id="Categorie" name="categoriep" type="text" value="<?PHP if(isset($categoriep)){ echo $categoriep; }?>" class="form-control" placeholder="Categorie">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-question-circle" aria-hidden="true"></i></span>
                                                        <input id="Type" name="typep" type="text" value="<?PHP if(isset($typep)){ echo $typep; }?>" class="form-control" placeholder="Type">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-stack-overflow" aria-hidden="true"></i></span>
                                                        <input id="Stock" name="stockp" type="number" value="<?PHP if(isset($stockp)){ echo $stockp; }?>" class="form-control" placeholder="Stock">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input id="Nomf" name="nomfp" type="text" class="form-control" placeholder="Nom Fournisseur">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <input type="submit" class="btn btn-primary waves-effect waves-light m-r-10" name="modifier" value="Modifier"></input>
                                                    <input type="hidden" name="id_ini" value="<?PHP if(isset($idp)){ echo $_POST['idp'];  print "ok2";}?>">
...
if (isset($_POST['modifier'])){
    $produit=new Produit($_POST['idp'],$_POST['nomp'],$_POST['prixp'],$_POST['codep'],$_POST['categoriep'],
    $_POST['typep'],$_POST['stockp'],$_POST['nomfp']);
