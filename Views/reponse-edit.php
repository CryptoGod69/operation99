                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Taper votre reponse</a></li>
                                    
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                        <form method="post" action="ajoutreponse.php" id="ajoutprod" >
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control"  placeholder="ID du client" name="ID_client" id="ID_client" required>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-sticky-note-o" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="reference de la reclamation" name="ref_reclam" id="ref_reclam" required>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-sticky-note-o" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Reponse" name="reponse" id="reponse" required>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    ...
                                                    <input type="sumbit" class="btn btn-warning waves-effect waves-light" name="Annuler" value="Annuler" disabled>
