...
$listeFournisseurs=$FournisseurC->AfficherFournisseur();
?>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <input style="width: 200px;" class="form-control" id="myInput" type="text" placeholder="Chercher un fournisseur..">
                            <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" value="Ajouter" onclick="window.location='AjouterFournisseur.php';">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?PHP echo $row['mat']; ?> <input type="hidden" value="<?PHP echo $row['mat']; ?>" name="mat"></td>
                            ...
                            <td>
                                ...
                                <form methode="SUBMIT" action="SupprimerFournisseur.php" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?PHP echo $row['id'];?>">
                                <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" value="Supprimer" >
                                </form>
                                
                                <form methode="SUBMIT" action="ModifierFournisseur.php" enctype="multipart/form-data">
                                 <input type="hidden" name="id" value="<?PHP echo $row['id'];?>">
