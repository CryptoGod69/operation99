                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <input style="width: 200px;" class="form-control" id="myInput" type="text" placeholder="Chercher un produit..">
                            <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" value="Ajouter" onclick="window.location='ajouterprodui_stock.php' ;">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?PHP  echo "<img src='images/".$row['image']."'>" ?>  <input type="hidden" value="<?PHP echo $row['image'];?>" name="image"></td>
                                    <td><?PHP echo $row['Descr']; ?><input type="hidden" value="<?PHP echo $row['Descr']; ?>" name="Descr">  </td>
                                    <td><?PHP echo $row['Categorie']; ?>  <input type="hidden" value="<?PHP echo $row['Categorie']; ?>" name="Categorie"></td>
                                    <td><?PHP echo $row['statut']; ?> <input type="hidden" value="<?PHP echo $row['statut']; ?>" name="statut"></td>
                                    <td><?PHP echo $row['Nom']; ?> <input type="hidden" value="<?PHP echo $row['Nom']; ?>" name="Nom"></td>
                                    <td><?PHP echo $row['Prix']; ?> <input type="hidden" value="<?PHP echo $row['Prix']; ?>" name="Prix"></td>
                                    <td><?PHP echo $row['quantity']; ?> <input type="hidden" value="<?PHP echo $row['quantity']; ?>" name="quantity"></td>
                                    <td><?PHP echo $row['Code_Barre']; ?> <input type="hidden" value="<?PHP echo $row['Code_Barre']; ?>" name="Code_Barre"></td>
                                    <td><?PHP echo $row['Fournisseur']; ?> <input type="hidden" value="<?PHP echo $row['Fournisseur']; ?>" name="Fournisseur"></td>
                            <td>
                                <form enctype="multipart/form-data">
                                <input type="hidden" name="" value="">
                                </form>

                                <form methode="SUBMIT" action="SupprimerStock.php" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?PHP echo $row['id'];?>">
                                <input type="hidden" name="Fournisseur" value="<?PHP echo $row['Fournisseur'];?>">
                                <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" value="Supprimer" >
                                </form>
                                
                                <form methode="SUBMIT" action="ModifierStock.php" enctype="multipart/form-data">
                                 <input type="hidden" name="id" value="<?PHP echo $row['id'];?>">
                                 <input type="hidden" name="Fournisseur" value="<?PHP echo $row['Fournisseur'];?>">
