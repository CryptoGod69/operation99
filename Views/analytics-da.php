...
$CouponC = new CouponC();
$NBprod=$ProduitC->affichernbrproduit();
$NBCoup=$CouponC->affichernbrCoupon();
$NBCateg=$CategorieC->affichernbrCateg();
$nbdispo=$ProduitC->affichernbdispo();
$nbnndispo=$ProduitC->affichernbnndispo();
$vmaxdomin=$ProduitC->categdom();
$nbcP=$CouponC->affichernbrCouponP();
$total=$CouponC->sommedescoupon();
?>
<!doctype html>
                        ...
                        <div class="income-dashone-total reso-mg-b-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    ...
                                    <?php
                                                      foreach($NBprod as $row1){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row1['COUNT(id)']; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($NBCoup as $row2){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row2['COUNT(id_coupon)']; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                        ...
                        <div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($NBCateg as $row3){
                                                          ?>
                                        <h3><span class="counter"><?PHP echo $row3['COUNT(id_cat)']; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                                ...
                                <div class="income-range visitor-cl">
                                    <p>Nombre Total des Categorie</p>
                        ...
                        <div class="income-dashone-total res-mg-t-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-adminpro-rate">
                                    <?php
                                                      foreach($vmaxdomin as $row5){
                                                          ?>
                                   
                                        <h3><span class="counter"><?PHP echo $row5['MAX(Categorie)']; ?></span></h3>
                                        <?PHP
}
?>
                                    </div>
                                ...
                                <div class="income-range low-value-cl">
                                    <p>La categorie dominante</p>
                                    
                                    <span class="income-percentange bg-purple"><span class="counter"></span> <i class="fa fa-level-down"></i>
                                    </span>
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="skill-content-3 analytics-adminpro">
                                <div class="skill">
                                    <div class="progress">
                                        ...
                                        <?php
                                                      foreach($nbdispo as $row4){
                                                      $pourcenta=$row4['COUNT(id)']*$row1['COUNT(id)']%100;
                                                          ?>
                                            <h3><span class="counter"><?PHP echo $pourcenta ?>%</span></h3>
                                            <p>Nbr des produits Disponible</p>
                                            <?PHP
}
?>
                                        </div>
                            ...
                            <div class="skill-content-3 analytics-adminpro analytics-adminpro4">
                                <div class="skill">
                                    <div class="progress">
                                        <div class="lead-content">
                                        <?php
                                        foreach ($nbcP as $row6){
                                           
$pour=$row6['COUNT(id_coupon)']*$row2['COUNT(id_coupon)']%100;
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="analytics-rounded reso-mg-b-30">
                            <div class="analytics-rounded-content">
                                <h5>Disponibilités des Produit</h5>
                                <?php 
                                foreach ($nbnndispo as $row9){
