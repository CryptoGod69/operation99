<?php 
require "../Core/produit_stockC.php";
require "../Entites/produit_stock.php";
$ProduitC1= new ProduitC();
$ProduitC2= new ProduitC();
$ListeProduit=$ProduitC1->afficherProduit();
$ListeProduit1=$ProduitC1->afficherProduit();
$ListeProduit2=$ProduitC2->affichermaxoc();
$v1=0;
?>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="product-edit">Ajouter un produit</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Promotion</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Promotion</a></li>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <SELECT name="Categorie" size="1" id="Categorie"    class="form-control" onchange="test();">
                                                    
                                                    <option value="Selectionner" disabled selected>Selectionner un Type Pour Ajouter De La Promotion </option>
                                                 
                                                     <OPTION value="0">Par ID</option>
                                                     <OPTION value="1">Par Categorie</option>
                                                     <OPTION value="2">Par Nombre  D'Etoiles</option>
                                  
</SELECT>

                                                       
</div>
                                                            <div class="input-group mg-b-pro-edt" id="show">
                                                        
                                                            <form id="idd" method="POST" onsubmit="return valeur();">
                                                        <SELECT name="id" size="1" id="id"    class="form-control" onchange="test();">
                                                    
                                                    <option value="Selectionner une id" disabled selected>Selectionner Un ID </option>
...
<input type="hidden" value="<?php echo $row['Categorie']; ?>" name="Categorie">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Taper La valeur en pourcentage" name="promovaleur" id="promovaleur" >
                                                        <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" name="save1" value="save" >
    ...
    if (isset($_POST['save1'])){
        $Produit1=new Produit($_POST['id'],$_POST['image'],$_POST['Descr'],$_POST['Categorie'],$_POST['statut'],$_POST['Nom'],$_POST['Prix'],$_POST['quantity'],$_POST['Code_Barre'],$_POST['Fournisseur']);
        $ProduitC->modifierpromoid($Produit1,$_POST['id'],$_POST['promovaleur']);
       
    }
    ?>
                                                    <div class="input-group mg-b-pro-edt" id="show1">
                                                      
                                                     <form method="POST" onsubmit="return valeur1();" id="categ">
                                                        <SELECT name="Categorie" size="1" id="Categorie"  class="form-control" onchange="test();">
                                                    
                                                    <option value="Selectionner une Categorie" disabled selected>Selectionner un Type </option>
                                                    <?php
                                                            foreach ($ListeProduit1 as $row1)
                                                            {
                                                     ...
                                                     <OPTION value="<?php echo $row1['Categorie']; ?>"><?php echo $row1['Categorie'] ?></option>
                                                     <?php
                                                            }
?>                                  
</SELECT>
                                                                ...
                                                                <input type="hidden" value="<?php echo $row['maxoc']; ?>" name="maxoc">
                                                        <input type="text" class="form-control" placeholder="Taper La valeur en pourcentage" name="promovaleur" id="promovaleur" >
                                                        <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" name="save2" value="save"  >
    ...
    if (isset($_POST['save2'])){
        $Produit11=new Produit($_POST['id'],$_POST['image'],$_POST['Descr'],$_POST['Categorie'],$_POST['statut'],$_POST['Nom'],$_POST['Prix'],$_POST['quantity'],$_POST['Code_Barre'],$_POST['Fournisseur']);
        $ProduitC1->modifierpromocateg($Produit11,$_POST['Categorie'],$_POST['promovaleur']);
    ...
    ?>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt" id="show2">
                                                       <form  method="POST" onsubmit="return valeur2();" id="maco">
                                                        <SELECT name="maxoc" size="1" id="maxoc"    class="form-control" onchange="test();">
                                                    
                                                    <option value="Selectionner Un Nombre Detoiles" disabled selected>Selectionner un nombre detoile </option>
                                                    <?php
                                                            foreach ($ListeProduit2 as $row2)
                                                            {
                                                            ?>
                                                     <OPTION value="<?php echo $row2['maxoc']; ?>"><?php echo $row2['maxoc'] ?></option>
                                                     <?php
                                                            }
?>                                  
</SELECT>
...
<input type="hidden" value="<?php echo $row['id']; ?>" name="id">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Taper La valeur en pourcentage" name="promovaleur" id="promovaleur" >
                                                        <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" name="save3" value="save" >
							
                            <input type="reset" class="btn btn-warning waves-effect waves-light" name="Annuler" value="Annuler" >
                                                    </form>
                                                    <?PHP
	 $ProduitC11= new ProduitC();

    if (isset($_POST['save3'])){
        $Produit111=new Produit($_POST['id'],$_POST['image'],$_POST['Descr'],$_POST['Categorie'],$_POST['statut'],$_POST['Nom'],$_POST['Prix'],$_POST['quantity'],$_POST['Code_Barre'],$_POST['Fournisseur']);
        $ProduitC11->modifierpromomaxoc($Produit111,$_POST['maxoc'],$_POST['promovaleur']);
...
<script>
 function test(){
    ...
    var y1 = document.getElementById("show1");
    var y2 = document.getElementById("show2");
...
function valeur()
{
	var promo=document.forms["idd"]["promovaleur"].value;
    if ( (promo >1) || (promo <0))
    {
        swal ("Le Pourcentage doit etre entre 0 et 1" , "" , "error");
        return false;
    }
    else
    {
        swal("Promotion Bien Enregistrer", "Verifier La Base ", "success");
        return true;
    }
}
function valeur1()
{
	var promo=document.forms["categ"]["promovaleur"].value;
    if ((promo >1) || (promo <0))
    {
        swal ("Le Pourcentage doit etre entre 0 et 1" , "" , "error");
        return false;
...
function valeur2()
{
	var promo=document.forms["maco"]["promovaleur"].value;
    if ((promo >1) || (promo <0))
    {
        swal ("Le Pourcentage doit etre entre 0 et 1" , "" , "error");
        return false;
