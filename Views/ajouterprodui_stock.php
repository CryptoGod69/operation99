...
$listeEmployes=$ProduitC->afficherProduit();
?>
                            ...
                            <tr>
                                ...
                                foreach($listeEmployes as $row){
                                    ?>
                                        ...
                                        <form  methode="POST" action="ajoutProduit.php" enctype="multipart/form-data" id="ajoutprod" onsubmit=" return verifa();">
                                     <tbody id="myTable">
                                <tr>
                                <?php
if ($row['statut']=="Disponible")
{
                                    ...
                                    <td><input type="number" name="quantity" min="1" max="1000" class="form-control" ></td>
                                <td><input type="number" name="Code_Barre"  class="form-control"></td>
                                <td><input type="text" name="Fournisseur"  class="form-control" id="Fournisseur"></td>
                              <td>
                                <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" name="save" value="Ajouter au stock" >
...
function verifa()
{
	var prix=document.forms["ajoutprod"]["prix"].value;
    var Fournisseur=document.forms["ajoutprod"]["Fournisseur"].value;
    if (prix >1000)
    {
        swal ("Le Prix Doit etre entre 0 et 1000" , "" , "error");
    return false;
    } 
