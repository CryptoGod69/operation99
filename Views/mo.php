                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="number" name="idc" value="<?PHP echo $idc ?>" class="form-control" >
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" name="qtp" value="<?PHP echo $qtp ?>" class="form-control" >
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-qrcode" aria-hidden="true"></i></span>
                                                        <input type="text" name="prixp" value="<?PHP echo $prixp ?>" class="form-control" >
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <button type="submit" name="modifier" value="modifier" class="btn btn-primary waves-effect waves-light m-r-10">Save
...
?>
   <script >window.location.href = "tableArticle.php";</script>
<?php
}
?>
