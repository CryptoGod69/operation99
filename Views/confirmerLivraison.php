...
$listelivraison=$livraisonC->afficherlivraisons2(0);
?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <td>
                                ...
                                <form methode="SUBMIT" action="confLivraison.php" enctype="multipart/form-data">
                                 <input type="hidden" name="id" value="<?PHP echo $row['id'];?>">
                                 <input type="hidden" name="email" value="<?PHP echo $row['email'];?>">
                                 <input type="hidden" name="adresse" value="<?PHP echo $row['adresse'];?>">
                                 <input type="hidden" name="cinLivreur" value="<?PHP echo $row['cinLivreur'];?>">
                                 <input type="hidden" name="dateLivraison" value="<?PHP echo $row['dateLivraison']; ?>">
                                 <input type="hidden" name="dureeLivraison" value="<?PHP echo $row['dureeLivraison']; ?>">
                                 <input type="hidden" name="etatLivraison" value="<?PHP echo $row['etatLivraison'];?>">
