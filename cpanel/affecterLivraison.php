...
$listelivraison=$livraisonC->afficherlivraisons3();
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" value="Ajouter" onclick="window.location='ajouterLivraison.php';">
                            ...
                            <td>
                                ...
                                <form methode="SUBMIT" action="affectLivraison.php" enctype="multipart/form-data">
                                 <input type="hidden" name="id" value="<?PHP echo $row['id'];?>">
                                 <input type="hidden" name="cin" value="<?PHP echo $_GET["cin"]?>">
                                <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" value="Affecter" >
                            	</form>
