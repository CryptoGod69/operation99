                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Confirmer une livraison</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
if (isset($_POST["id"]) && isset($_POST["maila"])){
	envoyerMail($_POST["maila"]);
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-minus-circle" aria-hidden="true"></i> Confirmer une livraison</a></li>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <input type="number" class="form-control" placeholder="ID" name="id" id="idprod" required>
                                                        </div>

                                                        <div class="input-group mg-b-pro-edt">
                                                                <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                                <input type="mail" class="form-control" placeholder="Adresse mail" name="maila" id="idprod" required>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" name="save" value="Valider" >
