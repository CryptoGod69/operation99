                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Confirmer un livreur</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
$listeLivreur=$livreur1C->afficherLivreurs0();
$LivreurC=new LivreurC();
if (isset($_POST["cin"]) and isset($_POST["tarifHoraire"])){
	$LivreurC->autolivreur($_POST["cin"],$_POST["tarifHoraire"],1);
}
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Confirmer un livreur</a></li>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <input type="number" class="form-control" placeholder="CIN" name="cin" id="idprod" required>
                                                        </div>
                                                        
                                                        <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-money" aria-hidden="true"></i></span>
                                                        <input type="number" class="form-control" placeholder="Tarif horaire" name="tarifHoraire" id="nomprod" required>
                                                        </div>
