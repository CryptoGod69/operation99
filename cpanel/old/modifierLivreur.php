...
if (isset($_POST['cin']) and isset($_POST['nom']) and isset($_POST['prenom']) and isset($_POST['numPermis']) and isset($_POST['rib']) and isset($_POST['numTel']) and isset($_POST['mdp']) and isset($_POST['nbHeuresTravail']) and isset($_POST['tarifHoraire'])){
	$livreurC->modifierlivreur($_POST['cin'],$_POST['nom'],$_POST['prenom'],$_POST['numPermis'],$_POST['rib'],$_POST['mail'],$_POST['numTel'],$_POST['mdp'],$_POST['nbHeuresTravail'],$_POST['tarifHoraire']);
}
?>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="password" class="form-control" placeholder="Mot de passe" name="mdp"  id="catprod" required>
