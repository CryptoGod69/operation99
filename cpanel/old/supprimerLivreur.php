                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Supprimer un livreur</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
?>        
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-minus-circle" aria-hidden="true"></i> Supprimer un livreur</a></li>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <input type="number" class="form-control" placeholder="CIN" name="cin" id="cin" required>
                                                        </div>
    ...
    <script src="../cpanel/js/controlesaisie1"></script>
</body>
