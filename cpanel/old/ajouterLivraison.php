                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Ajouter une livraison</a></li>
                                    
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                        <form method="post" action="registerLivraison.php" onsubmit="return verif1();">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Adresse de livraison" name="adresse" id="adresse" required>
                                                            </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                        <input type="number" class="form-control" placeholder="CIN Livreur" name="cinLivreur" id="cinLivreur" required>
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="Durée de livraison(minutes)" name="dureeLivraison"  id="catprod" required>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-hourglass" aria-hidden="true"></i></span>
                                                        <input type="date" class="form-control" name="dateLivraison" min="2019-04-24" id="catprod" required>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" name="ajouter" value="Ajouter" >
