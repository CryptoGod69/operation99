...
<head>
    ...
    <meta name="prenomiption" content="">
...
$listelivraison=$livreur->afficherlivreurs0();
?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <td>
                                ...
                                <form methode="SUBMIT" action="ajoutLivreur.php" enctype="multipart/form-data">
                                 ...
                                 <input type="hidden" name="numPermis" value="<?PHP echo $row['numPermis'];?>">
                                 <input type="hidden" name="rib" value="<?PHP echo $row['rib']; ?>">
                                 <input type="hidden" name="mail" value="<?PHP echo $row['mail']; ?>">
                                 <input type="hidden" name="numTel" value="<?PHP echo $row['numTel'];?>">
                                 <input type="hidden" name="mdp" value="<?PHP echo $row['mdp'];?>">
                                 <input type="hidden" name="nbHeuresTravail" value="<?PHP echo $row['nbHeuresTravail'];?>">
                                 <input type="hidden" name="tarifHoraire" value="<?PHP echo $row['tarifHoraire'];?>">
