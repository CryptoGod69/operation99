                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <input class="btn btn-primary waves-effect waves-light m-r-10" type="submit" value="Afficher" onclick="window.location='afficherLivraison.php';">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                        <form method="post" onsubmit="return verif1();">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-hourglass" aria-hidden="true"></i></span>
                                                        <input type="mail" class="form-control" placeholder="E-mail" name="email" id="catprod" required>
                                                    </div>
...
if (isset($_POST['adresse']) and isset($_POST['dureeLivraison']) and isset($_POST['email'])){
$livraison1=new livraison($_POST['adresse'],0,$_POST['dureeLivraison'],0,$_POST['email']);
$livraison1->setDateLivraison($d);
