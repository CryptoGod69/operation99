...
if (isset($_GET["id"])){
$pmod=$livraisonC->recupererlivraison($_GET["id"]);
}
?>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <input style="width: 200px;" class="form-control" id="myInput" type="text" placeholder="Chercher un livraison..">
                            ...
                            <tr>
                                ...
                                foreach($pmod as $row){
                                    ?>
                                        ...
                                        <form  method="POST" action="modLivraison.php" enctype="multipart/form-data">
                                     <tbody id="myTable">
                                <tr>
                                    <td><?PHP echo $row['id']; ?>  <input type="hidden" value="<?PHP echo $row['id']; ?>" name="id"></td>

                                    <td><input type="texte" name="adresse" min="1" class="form-control"></td>

                                    <td><?PHP echo $row['cinLivreur']; ?>  <input type="hidden" value="<?PHP echo $row['cinLivreur']; ?>" name="cinLivreur"></td>

                                    <td><input type="date" name="dateLivraison" min="1" class="form-control"></td>
                                    
                                    <td><input type="number" name="dureeLivraison" min="1" max="1000" class="form-control"></td>
