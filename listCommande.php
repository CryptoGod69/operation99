                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
                                ...
                                <li>
                            <a class="has-arrow" href="" aria-expanded="false"><i class="fa big-icon fa-table icon-wrap"></i> <span class="mini-click-non">Commandes</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Data Table" href="Article.php"><i class="fa fa-th sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Contenu des Commandes</span></a></li>
                            </ul>
                        </li>
                        </li>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <h4>Commandes List</h4>
                            
                            <?PHP
require_once "../CPanel/config.php";
include_once "C:/xampp/htdocs/CPanel/core/CommandeC.php";
