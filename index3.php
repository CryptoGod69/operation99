	...
	<body>
								...
								<div class="dropdown">
									...
									<div class="cart-dropdown">
										...
										<div class="cart-summary">
											<small>Will be generated</small>
											<h5><?php $total = $total + ($values["item_quantity"] * $values["item_price"]);?></h5>
										</div>
										<div class="cart-btns">
											<a href="#">View Cart</a>
		...
		<div class="section">
			...
			<p class="product-category"><?php echo $row["category"]?></p>
				<form   method="post">
					<div class="product-img">
						<img  class="center" src="images/<?php echo $row["image"]; ?>" class="img-responsive" /><br />
						<span class="new">NEW</span>
						<h4 class="product-name"><?php echo $row["name"]; ?></h4>
						<h4 class="product-price">DT <?php echo $row["price"]; ?></h4>
        ...
        ?>
										...
										<form method="post">
											<div class="product-img">
												<img class="center" src="images/<?php echo $row["image"]; ?>" class="img-responsive" >
											</div>
											<div class="product-body">
												<p class="product-category"><?php echo $row["category"]; ?></p>
												<h3 class="product-name"><a href="#"><?php echo $row["name"]; ?></a></h3>
												<h4 class="product-price"><a href="#"><?php echo $row["price"]; ?> DT </a></h4>
...
?>
		...
		<div style="clear:both"></div>
			...
			<?php echo $message; ?>
			<div align="right">
				<a href="index3.php?action=clear"><b>Clear Cart</b></a>
			</div>
