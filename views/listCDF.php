...
<head>
    ...
    <title>Area Charts | jeweler - Material Admin Template</title>
                                                ...
                                                <li class="nav-item nav-setting-open"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa fa-tasks"></i></a>
                                                    ...
                                                    <div role="menu" class="admintab-wrap menu-setting-wrap menu-setting-wrap-bg dropdown-menu animated zoomIn">
                                                        <ul class="nav nav-tabs custon-set-tab">
                                                            <li class="active"><a data-toggle="tab" href="#Notes">CDF</a>
                                                            </li>
                                                            ...
                                                            <div id="Notes" class="tab-pane fade in active">
                                                                <div class="notes-area-wrap">
                                                                    <div class="note-heading-indicate">
                                                                        <h2><i class="fa fa-comments-o"></i> Latest CDF</h2>
                                                                        <p>You have 10 New CDF.</p>
                                                                    </div>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Chartsmob" href="#">Clients <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul id="Chartsmob" class="collapse dropdown-header-top">
                                                <li><a href="List.html">List Client</a>
                                                </li>
                                                <li><a href="Diagramme.html">Diagramme</a>
                                                </li>
                                                <li><a href="ModifierSupprimer.html">Mofier/Supprimer</a>
                                                </li>
                                                </li>
                                                <li><a href="ListCDF.html">List Email des CDF</a>
                                                </li>
...
$CDF1C=new CDFC();
$listeCDF=$CDF1C->afficheCDF();

//var_dump($listeCDFs->fetchAll());
?>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd" align="center">
                                    <h1>List <span class="table-project-n">Des</span> Clients CDF</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="IDCDF" >IDCDF</th>
                                                <th data-field="NomFedi" >Nom du proprietaire</th>
                                                <th data-field="points" >points</th>
                                                <th data-field="REFCDF" >Reference de la carte</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?PHP
	...
	<td><?PHP echo $row['IDCDF']; ?></td>
	<td><?PHP echo $row['NomFedi']; ?></td>
    <td><?PHP echo $row['points']; ?></td>
    <td><?PHP echo $row['REFCDF']; ?></td>
	<td><form method="POST" action="supprimerCDF.php">
	<input type="submit" name="supprimer" value="supprimer">
	<input type="hidden" value="<?PHP echo $row['REFCDF']; ?>" name="REFCDF">
	</form>
	</td>
	</tr>
	<?PHP
